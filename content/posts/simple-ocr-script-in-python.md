---
slug: simple-ocr-script-in-python
date: 2019-11-29
title:  Using Azure Cognative Services Computer Vision with Python to Extract Handwritten Text 

summary: To help my daughter convert a hand-written essay into an electronic format I wrote a Python script that uses Azure Cognative Services to extract text from handwriting.
---
