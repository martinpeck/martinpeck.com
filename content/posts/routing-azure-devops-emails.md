---
slug: routing-azure-devops-emails
date: 2019-11-29
title:  Using Message Headers to build Inbox Rules for Azure DevOps Notifications Emails

summary: If you're drowing under notification e-mails from Azure Devops, and want to build some Inbox rules to manage things, then there are some useful message headers you can use for routing.
---
