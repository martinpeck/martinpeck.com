...
author: Martin Peck
description: Part 1 of 2, where I describe how I'm using Docker to make local Jekyll
  site development easier, and avoid having to set up a Ruby development environment.
categories:
- Jekyll
- blog
- containers
