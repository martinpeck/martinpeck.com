---
title: Using Azure Cognative Services Computer Vision with Python to Extract Handwritten
  Text
author: Martin Peck
description: To help my daughter convert a hand-written essay into an electronic format
  I wrote a Python script that uses Azure Cognative Services to extract text from
  handwriting.
date: '2019-11-29'
image: /images/default-post-cover.svg
---
